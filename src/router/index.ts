...
import { ErrorPageRoute, LoginRoute, RootRoute, tabBarRoute } from '@/router/base'
import { useRouteStoreWithOut } from '@/store/modules/route'

// 菜单

// 普通路由
export const constantRouter: RouteRecordRaw[] = [LoginRoute, RootRoute, ErrorPageRoute, tabBarRoute]
